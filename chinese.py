...
def addHeader(counter, heading):
    ...
    root_list["lzh-iti"+str(counter)+":0.2"] = "("+str(counter)+")"
    root_list["lzh-iti"+str(counter)+":0.3"] = heading.textwriter
    root_list["lzh-iti"+str(counter)+":0.4"] = heading.textsub
    reference_list["lzh-iti"+str(counter)+":0.1"] = "t17.0765"

    html_list["lzh-iti"+str(counter)+":0.1"] = "<article id='lzh-iti"+str(counter)+"'><header><ul><li class='division'>{}</li></ul>"
    html_list["lzh-iti"+str(counter)+":0.2"] = "<h1 class='sutta-title'>{}</h1></header>"
    html_list["lzh-iti"+str(counter)+":0.3"] = "{}"
    html_list["lzh-iti"+str(counter)+":0.4"] = "{}"
